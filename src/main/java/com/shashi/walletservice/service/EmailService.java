...
public class EmailService {
     public static void sendEmail(String toEmail){
        final String fromEmail = "velann21@gmail.com"; //requires valid gmail id
        final String password = "Siar@1234"; // correct password for gmail id
    ...
    {
        final String userName = "velann21@gmail.com"; //requires valid gmail id
        final String password = "Siar@1234"; // correct password for gmail id
